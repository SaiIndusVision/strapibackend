...
export interface ApiAboutUsAboutUs extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    webSiteKeys: Schema.Attribute.Component<
...
export interface ApiAnnouncementAnnouncement
  ...
  attributes: {
    announcementText: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiBannerBanner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    BannerImage_Video: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
...
export interface ApiHeaderHeader extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    AdvisoryServices: Schema.Attribute.Component<
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Framework: Schema.Attribute.Component<'frameworks.cf-frameworks', true>;
    HeaderAppliedTo: Schema.Attribute.Component<'websites.websites', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::header.header'
    > &
      Schema.Attribute.Private;
    Placeholder1: Schema.Attribute.String;
    Placeholder2: Schema.Attribute.String;
    Placeholder3: Schema.Attribute.String;
    Placeholder4: Schema.Attribute.String;
